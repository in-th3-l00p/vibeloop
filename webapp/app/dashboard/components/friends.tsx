      ...
      <Sheet>
        ...
        <SheetContent side="right" className="flex flex-col !p-0">
          ...
          <div className="flex-1 overflow-y-auto scrollbar-thin px-3 py-2 space-y-0.5">
            {sorted.map((friend) => (
              <button key={friend.tag} onClick={() => setSelected(friend)} className="cursor-pointer w-full flex items-center gap-3 rounded-lg px-3 py-2.5 transition-all duration-200 hover:bg-white/5 group">
