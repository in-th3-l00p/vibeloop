  ...
  return (
    <div className="flex items-center justify-between mb-3">
      ...
      {action && href && (
        <Link
          href={href}
          className="text-[10px] uppercase tracking-wider text-muted-foreground rounded-md px-2.5 py-1 bg-card ring-1 ring-border transition-all duration-300 hover:text-white"
        >
          {action}
        </Link>
      )}
